...
bcmath.bcadd = function(left_operand, right_operand, scale) {
 ...
 * @return string
 */
bcmath.bcsub = function(left_operand, right_operand, scale) {
    var first, second, result;
 ...
 */
bcmath.bccomp = function(left_operand, right_operand, scale) {
 ...
 */
bcmath.bcdiv = function(left_operand, right_operand, scale) {
    var first, second, result;
 ...
 * @return string                   The result as a string
 */
bcmath.bcmul = function(left_operand, right_operand, scale) {
    var first, second, result;
 ...
 */
bcmath.bcround = function(val, precision) {
    var x, r;
    ...
    r = this.bcadd(val, x, precision);

    return r;
};

module.exports = bcmath;
